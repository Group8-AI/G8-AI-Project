    ...
    <header style={styles.header}>
      ...
      <nav style={styles.nav}>
        <a
          ...
          style={
            isActive("/admin/dashboard") ? styles.activeNavLink : styles.navLink
          }
        >
          Dashboard
        </a>
        <a
          href="/admin/database"
          style={
            isActive("/admin/database") ? styles.activeNavLink : styles.navLink
          }
        >
          Database
        </a>
      ...
      <div style={styles.loginButtonWrapper}>
        {shouldShowLoginButton &&
          !isAuthenticated && ( // Show log in button only when not authenticated
