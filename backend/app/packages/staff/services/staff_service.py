...
class StaffService(BaseService):
    ...
    def account_response(self, data):
        """Create an account response based on data."""
        # Here you fetch employee details based on ID
        employee = self.model.get_account_by_id(data['idEmployee'])
